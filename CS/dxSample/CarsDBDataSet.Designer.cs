...
namespace dxSample {
    ...
    public partial class CarsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CarsRow AddCarsRow(string Trademark, string Model, decimal Price) {
...
namespace dxSample.CarsDBDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `Price`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `Price` = ? WHERE ((`ID` = ?) AND" +
                " ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dxSample.Properties.Settings.Default.CarsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Trademark, Model, Price FROM Cars";
        ...
        public virtual int Delete(int Original_ID, string Original_Trademark, string Original_Model, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(string Trademark, string Model, global::System.Nullable<decimal> Price) {
            if ((Trademark == null)) {
        ...
        public virtual int Update(string Trademark, string Model, global::System.Nullable<decimal> Price, int Original_ID, string Original_Trademark, string Original_Model, global::System.Nullable<decimal> Original_Price) {
            if ((Trademark == null)) {
