...
Namespace dxSample
	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CarsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCarsRow(ByVal Trademark As String, ByVal Model As String, ByVal Price As Decimal) As CarsRow
				Dim rowCarsRow As CarsRow = (CType(Me.NewRow(), CarsRow))
				Dim columnValuesArray As Object() = New Object() { Nothing, Trademark, Model, Price}
	...
	End Class
End Namespace
Namespace dxSample.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Tr" & "ademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AN" & "D `Price` IS NULL) OR (`Price` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `Price`) VALUES (?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `Price` = ? WHERE ((`ID` = ?) AND" & " ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` " & "IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, Trademark, Model, Price FROM Cars"
		...
		Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
			...
			If (Original_Price.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CDec(Original_Price.Value))
			Else
		...
		Public Overridable Function Insert(ByVal Trademark As String, ByVal Model As String, ByVal Price As Global.System.Nullable(Of Decimal)) As Integer
			...
			If (Price.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(2).Value = (CDec(Price.Value))
			Else
		...
		Public Overridable Function Update(ByVal Trademark As String, ByVal Model As String, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
			If (Trademark Is Nothing) Then
			...
			End If
			If (Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(2).Value = (CDec(Price.Value))
			Else
			...
			If (Original_Price.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CDec(Original_Price.Value))
			Else
